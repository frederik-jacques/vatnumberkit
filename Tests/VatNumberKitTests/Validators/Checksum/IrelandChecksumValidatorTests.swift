...
final class IrelandChecksumValidatorTests: XCTestCase {
    ...
    func testValidNewIrishVatNumberWith1LetterAtTheEnd() throws {
        let sut = VatNumberKit.validateChecksum(vatNumber: "IE6388047V")
        XCTAssertTrue(sut)
    }
    
    func testValidNewIrishVatNumberWithLetterWAtTheEnd() throws {
        let sut = VatNumberKit.validateChecksum(vatNumber: "IE4807499W")
        XCTAssertTrue(sut)
    }
    
    func testValidNewIrishVatNumberWithLetterCAtTheEnd() throws {
        let sut = VatNumberKit.validateChecksum(vatNumber: "IE9767830C")
        XCTAssertTrue(sut)
    }
    
    func testInvalidNewIrishVatNumberWith1LetterAtTheEnd() throws {
        let sut = VatNumberKit.validateChecksum(vatNumber: "IE6388046V")
        XCTAssertFalse(sut)
    }
    
    func testValidNewIrishVatNumberWith2LettersAtTheEnd() throws {
        let sut = VatNumberKit.validateChecksum(vatNumber: "IE3668997OH")
        XCTAssertTrue(sut)
    }
    
    func testInvalidNewIrishVatNumberWith2LetterAtTheEnd() throws {
        let sut = VatNumberKit.validateChecksum(vatNumber: "IE3668998OH")
        XCTAssertFalse(sut)
    }
    
    func testInvalidIrishVatNumberWithIncorrectFormat() throws {
        let sut = VatNumberKit.validateChecksum(vatNumber: "IE6347V")
        XCTAssertFalse(sut)
    }
